...
const  Tenantschatsidebar= ({onSelectUser}) => {
  ...
  return (
    <div className='lg:w-[350px] md:w-[350px] w-[300px] min-h-screen lg:ml-10 md:ml-5 ml-5 bg-white p-5'>
      ...
      <div className='flex justify-between mt-5'>
        <Link to='#'>All</Link>
        <Link to='/chats' >Owners</Link>
        <Link to='/tenant-chats' className='border-b-2 border-[blue] font-semibold'>Tenants</Link>
...
export default Tenantschatsidebar
